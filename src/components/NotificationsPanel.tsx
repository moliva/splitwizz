  ...
  return <div class={editGroupstyles.modal}>
    <div class={editGroupstyles["modal-content"]}>
      ...
      <div class={styles['notification-cards']}>
        <Switch fallback={<div class={groupStyles['settled-up-container']}><label class={groupStyles['settled-up']} style={{ 'font-size': '20px', "margin-bottom": '15px' }}>All settled! 🪄</label></div>}>
      ...
      <div class={editGroupstyles['modal-controls']}>
        <button class={`${styles.button} ${styles.delete}`} onClick={onArchiveAll} disabled={(notifications() ?? []).length === 0}>Archive all</button>
